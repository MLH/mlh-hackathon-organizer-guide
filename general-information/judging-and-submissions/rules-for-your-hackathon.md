...
* Will you require hackers to agree to the MLH Code of Conduct?
  * We recommend requiring every hacker to read and agree to the [MLH Code of Conduct](https://github.com/MLH/mlh-policies/blob/main/code-of-conduct.md) at registration (e.g. a compulsory checkbox), restating it in your opening ceremony, and keeping it visible at the help desk for the whole event — not just the opening remarks.
...
* You must read and agree to the MLH Code of Conduct (https://github.com/MLH/mlh-policies/blob/main/code-of-conduct.md). Violations can lead to disqualification and removal from the event.
