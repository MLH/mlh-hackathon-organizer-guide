...
* TechTogether Meetups: An underrepresented gender meetup to provide attendees opportunities to connect, share ideas, and discuss industry challenges.
...
{% content-ref url="techtogether-meetups.md" %}
[techtogether-meetups.md](techtogether-meetups.md)
{% endcontent-ref %}
